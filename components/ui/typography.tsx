...
const variants = {
  h1: "font-heading leading-none text-3xl xs:text-[54px] xl:text-[72px] 2xl:text-[71px] 3xl:text-[91px] 3xl:leading-[91px] text-title",
  ...
  "p-hero": "md:leading-7 text-[22px] xl:leading-8 2xl:text-[24px] 3xl:text-[31px] 3xl:leading-[43px] 2xl:tracking-[-1.1px] text-body",
  "p-large": "text-[18px] text-body lg:text-[21px] 2xl:text-[24px] 3xl:text-[27px] 4xl:text-[30px] leading-[124%] lg:leading-[28px] 2xl:leading-[32px] 3xl:leading-[38px] 4xl:leading-[43px]",
